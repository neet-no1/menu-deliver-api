...
public interface ArticlesMapper {
	 ...
	 * @mbg.generated  Sun Mar 28 05:17:09 JST 2021
	 */
	@Insert({ "insert into articles (id, user_id, ", "title, start_sentence, ", "path, opened, created_at, ",
			"updated_at)", "values (#{id,jdbcType=INTEGER}, #{userId,jdbcType=INTEGER}, ",
			"#{title,jdbcType=VARCHAR}, #{startSentence,jdbcType=VARCHAR}, ",
			"#{path,jdbcType=VARCHAR}, #{opened,jdbcType=BIT}, #{createdAt,jdbcType=TIMESTAMP}, ",
	 ...
	 * @mbg.generated  Sun Mar 28 05:17:09 JST 2021
	 */
	@Select({ "select", "id, user_id, title, start_sentence, path, opened, created_at, updated_at", "from articles",
	...
	@Update({ "update articles", "set user_id = #{userId,jdbcType=INTEGER},", "title = #{title,jdbcType=VARCHAR},",
			"start_sentence = #{startSentence,jdbcType=VARCHAR},", "path = #{path,jdbcType=VARCHAR},",
