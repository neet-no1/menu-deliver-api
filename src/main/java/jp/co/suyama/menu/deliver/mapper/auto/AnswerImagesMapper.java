...
public interface AnswerImagesMapper {
     ...
     * This method corresponds to the database table answer_images
     *
     ...
     */
    @Insert({
        "insert into answer_images (id, answer_id, ",
        "path, created_at, ",
        "updated_at)",
    ...
    @Select({
        "select",
        "id, answer_id, path, created_at, updated_at",
        "from answer_images",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
