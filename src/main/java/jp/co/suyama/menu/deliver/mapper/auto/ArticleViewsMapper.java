...
public interface ArticleViewsMapper {
     ...
     * This method corresponds to the database table article_views
     *
     ...
     */
    @Insert({
        "insert into article_views (article_id, date, ",
        "count)",
        "values (#{articleId,jdbcType=INTEGER}, #{date,jdbcType=TIMESTAMP}, ",
