...
public interface QuestionsMapper {
	 ...
	 */
	@Delete({ "delete from questions", "where id = #{id,jdbcType=INTEGER}" })
	 ...
	 * @mbg.generated  Fri Mar 19 20:01:37 JST 2021
	 */
	@Insert({ "insert into questions (id, user_id, ", "contents, answer_id, ", "created_at, updated_at)",
	 ...
	 * @mbg.generated  Fri Mar 19 20:01:37 JST 2021
	 */
	@Select({ "select", "id, user_id, contents, answer_id, created_at, updated_at", "from questions",
	 ...
	 * @mbg.generated  Fri Mar 19 20:01:37 JST 2021
	 */
	@Update({ "update questions", "set user_id = #{userId,jdbcType=INTEGER},",
			"contents = #{contents,jdbcType=VARCHAR},", "answer_id = #{answerId,jdbcType=INTEGER},",
