...
public interface MenuPicturesMapper {
     ...
     * This method corresponds to the database table menu_pictures
     *
     ...
     */
    @Insert({
        "insert into menu_pictures (id, menu_id, ",
    ...
    @Select({
        "select",
        "id, menu_id, path, order_of, created_at, updated_at",
        "from menu_pictures",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
